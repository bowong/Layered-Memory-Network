...
def build_model(input_video, input_stories, input_question, input_answer, 
    ...
    with tf.variable_scope('video_subtitle_hierarchical_frame_clip') as scope:
        ...
        # encode video
        embedded_video = SEModelUtil.getVideoDualSemanticEmbeddingWithQuestionAttention_up(input_video, T_w2v, embeded_stories, embedded_question, T_B, pca_mat=pca_mat) # batch x timesteps x d_w2v
